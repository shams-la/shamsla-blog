...
class FollowingUsers(models.Model):
    ...
    followings = models.ForeignKey(Profile, related_name="followings", on_delete=models.CASCADE)
...
class FollowerUsers(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name="follower_user")
    followers = models.ForeignKey(Profile, related_name="followers", on_delete=models.CASCADE)
